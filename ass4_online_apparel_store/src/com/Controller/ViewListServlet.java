	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (resultset.next()) {
				...
				if(resultset2.next()) {
					out.println("<ul>\n"
							+ "  <li><a href=\"viewall.jsp\">All Items</a></li>\n"
							+ "  <li><a class=\"active\" href=\"viewlist.jsp\"> "+user.getType()+" Items</a></li></ul>");
					out.println("<br><br><h2> Preffered "+user.getType()+" Item-list </h2>");
					...
					do {
						...
						out.println("<tr><td>"+item.getName()+"</td><td>"+item.getPrice()+"</td><tr>");
						//break;
					...
					out.println("<ul>\n"
							+ "  <li><a href=\"viewall.jsp\">All Items</a></li>\n"
							+ "  <li><a class=\"active\" href=\"viewlist.jsp\">Prefered Items</a></li></ul>");
					out.println("<div><h1>No apparel found according to your preferences!</h1></div>");
